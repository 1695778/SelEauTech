 ...
 * @author 1695778
 */
public class Servlet_Sanitation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        maListe = dataManager.getListeSanitation();
        request.setAttribute("sanitation", maListe);

        RequestDispatcher disp = getServletContext().getRequestDispatcher("/listerSanitation.jsp");
